...
float sDetailScale = 5;         // Repeat interval of the texture
...
float sStrength = 1;          // 0 to 1 for the strength of the effect
float sAnisotropy = 1;        // 0 to 1 for the amount anisotropy of the effect - Higher looks better but can be slower
